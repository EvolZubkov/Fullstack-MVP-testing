...
CREATE INDEX "media_usages_entity_idx" ON "media_usages" USING btree ("entity_type","entity_id");--> statement-breakpoint
CREATE INDEX "media_usages_asset_idx" ON "media_usages" USING btree ("asset_id");