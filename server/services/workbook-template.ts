...
export const EXAMPLE_ROWS: Record<string, Record<string, unknown>[]> = {
  ...
  [SHEET_RECOMMENDATIONS]: [
    { "Кому": "Тест", "Раздел": "", "Тип": "Курс", "Заголовок": "Финансы для руководителя", "Ссылка": "https://example.test/finance" },
    { "Кому": "Тест", "Раздел": "", "Тип": "Материал", "Заголовок": "Памятка по отчётности", "Ссылка": "https://example.test/memo.pdf" },
    // У мероприятия ссылки может не быть вовсе: очная встреча живёт в расписании,
    // а не на странице записи.
    { "Кому": "Тест", "Раздел": "", "Тип": "Мероприятие", "Заголовок": "Вебинар «Разбор отчётности»", "Ссылка": "" },
    { "Кому": "Раздел", "Раздел": "Финансы", "Тип": "Курс", "Заголовок": "Основы финансового учёта", "Ссылка": "https://example.test/accounting" },
  ],
...
const HELP_ROWS: HelpRow[] = [
  ...
  [SHEET_FEEDBACK, "Кому", "да", "Чья это обратная связь: Тест (общая, на экране итогов) | Раздел (по одной теме).", "Раздел"],
  [SHEET_FEEDBACK, "Раздел", "да, для «Кому» = «Раздел»", "Название темы — как на листе «Структура». Для «Кому» = «Тест» ячейка должна быть ПУСТОЙ: заполненная — ошибка строки, а не молчаливо отброшенное значение.", "Финансы"],
  ...
  [SHEET_RECOMMENDATIONS, "Кому", "да", "Чьей обратной связи принадлежит рекомендация: Тест | Раздел. Читается так же, как на листе «Обратная связь».", "Тест"],
  [SHEET_RECOMMENDATIONS, "Раздел", "да, для «Кому» = «Раздел»", "Название темы. Для «Кому» = «Тест» ячейка пустая. Владелец обязан быть назван на листе «Обратная связь», иначе строка отвергается: рекомендация хранится внутри его обратной связи.", "Финансы"],
