...
const HELP_ROWS: HelpRow[] = [
  ...
  [SHEET_STRUCTURE, "Обратная связь при непройденном уровне", "нет", "Текст, который видит ученик адаптивной темы, не взявший уровень. Значение ОДНО на тему, поэтому оно здесь, а не на листе «Адаптивные уровни». Пусто — текст остаётся прежним.", "Вернитесь к материалам уровня и повторите попытку."],
  ...
  [SHEET_RECOMMENDATIONS, "Кому", "да", "Чьей обратной связи принадлежит рекомендация: Тест | Раздел | Уровень (материал уровня адаптивной темы). Тест и Раздел читаются так же, как на листе «Обратная связь».", "Тест"],
