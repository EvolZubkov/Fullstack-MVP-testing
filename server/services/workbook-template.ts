...
const HELP_ROWS: HelpRow[] = [
  ...
  ["", "", "", "Вопросы → Шкалы → Показатели → Вклады вопросов → Оценка → Структура + Квоты + Пороги вариантов + Обратная связь + Рекомендации. Поэтому ссылки на вопросы, созданные этим же файлом, работают.", ""],
