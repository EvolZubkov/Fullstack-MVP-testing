 ...
 * actions/answers). Review highlight applies only when the answer is locked (feedback
...
function renderSingleQuestionInput(q, answer, locked, correct, shuffleMapping) {
  ...
  return TB.renderSingleChoice({ type: 'single', dataJson: q.data }, answer, shuffleMapping, locked ? correct : undefined);
}
