...
> **ARCHIVED.** Replit-документация прошлой ревизии проекта. После массового обновления npm-пакетов (2026-05)
> ряд упомянутых здесь библиотек удалён или мажорно обновлён. Источник истины — `README.md` и `package.json` в корне.
