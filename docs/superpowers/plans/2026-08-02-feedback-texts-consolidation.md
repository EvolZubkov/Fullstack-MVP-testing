...
| Развилка | Решение |
| --- | --- |
| Источник текста | `feedback_json.text` темы, раздела и теста; легаси `topics.feedback` — запасное чтение для тем, которых не касался нынешний редактор |
...
| Правило видимости по теме | Всё по теме — текст, курсы, мероприятия, вложения — только при НЕпройденной теме |
...
### Task 4: Одно правило видимости по теме
