...
**Версия:** 1.10
**Статус:** Утверждено
**Источник:** [BRD](./specs/brd-scorm-enhancements.md), PRD-1...PRD-18
**Последняя актуализация:** 2026-06-27 (Трек PRD-18 «Встроенный плеер тестирования и отладки
тестов» — отдельный BRD BR-13/Этап 14, спека
