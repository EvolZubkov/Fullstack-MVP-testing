...
**Статус:** реализован golden-тест. Проверки #7-#9 (Excel-выгрузка WebTutor)
подтверждаются при live-LMS прогоне (§7 п.1) — недоступны локально.
