...
надписи интерфейса итогов и порядок их подблоков — §8.3.1-8.3.3 и §10.5. Ещё не действующие
возможности вынесены в §3.  
**Версия:** 1.5.0 (см. [«История версий»](#история-версий))  
