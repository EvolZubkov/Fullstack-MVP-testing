...
**Статус:** S9 закрыта 2026-05-27 (тесты + FR-20c); S10 — следующая
**Связанные документы:**
...
| S10 | Удаление legacy | **Активна (следующая)** | Зависит от S9 (закрыта) |
...
| S10 | 7A | Удаление legacy | Sonnet | 7B | **Активна (следующая)** |
