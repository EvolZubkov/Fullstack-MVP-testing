...
> **ARCHIVED.** Снимок зависимостей на дату ниже. После массового обновления npm-пакетов (2026-05)
> часть упомянутых тут библиотек удалена или мажорно обновлена. Источник истины — `package.json` в корне.
