...
**Версия:** 1.0  
**Статус:** Черновик  
**Связанные документы:** [BRD](brd-scorm-enhancements.md), [PRD-2](prd-2-result-variables.md), [PRD-4](prd-4-course-flow-sections.md), [Платформа SCORM-шаблонов](spec-template-platform.md)  
**Этап BRD:** BR-06, Этап 6  
**Зависимости:** стандартная оценка Core, результаты разделов из PRD-4, пользовательские показатели из PRD-2
