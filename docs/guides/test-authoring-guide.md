...
ним — подзаголовки блоков «Общий балл», «По шкалам», «По показателям», «По темам», а ниже —
ещё один общий заголовок, «Рекомендации». В подразделе «Итоги» каждую из этих надписей можно
...
Там же, в «Заголовках и подписях», задаётся порядок четырёх блоков: перетащите их в нужной
последовательности. Порядок, который вы не трогали, совпадает с тем, что был всегда.
...
- Если тест уходит в LMS — проверено, какие шкалы и показатели публикуются.
