...
Записать в матрицу, сколько блоков видно без прокрутки при каждом размере. Если показатель
занимает первый экран целиком и шкалы уходят под сгиб — размеры пересмотреть.
