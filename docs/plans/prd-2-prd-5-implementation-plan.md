...
**Статус:** РЕАЛИЗОВАНО 2026-06-03 (Этапы A-C). Закрыто; остаток — отложенные точечные
пункты (градуированный checkAnswer, RTK-слой, C2-фастфоллоу, композитные шкалы, глобальная
библиотека шкал), см. ROADMAP §0.2, HANDOFF.md §4 и GitHub issues #12/#17/#23/#24/#25/#26.
**Дата:** 2026-05-31 (план); 2026-06-03 (закрытие реализации)
