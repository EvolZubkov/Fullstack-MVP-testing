  ...
  it("dims the «Обзор теста» slot with a comment when return-to-unanswered is OFF", async () => {
    ...
    renderSection(
      baseModel({
        ...
        runtime: { timeLimitMinutes: null, maxAttempts: null, showCorrectAnswers: false, allowReturnToUnanswered: false, allowAnswerChange: false, showSectionResults: true, copyProtection: true, protectionWatermark: false, protectionHideOnBlur: false },
      }),
    );
