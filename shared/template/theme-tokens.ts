/**
 * @module shared/template/theme-tokens
 * @description Reads a design template's colour TOKENS out of its stylesheet, so
 * the «Цвета» pane can show the colour a parameter actually paints with
 * instead of a placeholder, and so the manifest validator can tell whether a
 * theme the template DECLARES is actually backed by tokens (PRD-23 FR-04).
 *
